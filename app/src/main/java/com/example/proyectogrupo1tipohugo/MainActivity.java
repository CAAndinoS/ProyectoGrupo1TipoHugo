...
import com.example.proyectogrupo1tipohugo.databinding.ActivityMainBinding;
import com.example.proyectogrupo1tipohugo.databinding.PerfilRBinding;
import com.example.proyectogrupo1tipohugo.login.Recuperar_Clave;
import com.example.proyectogrupo1tipohugo.login.RegistroActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Animation anim;
    private com.example.proyectogrupo1tipohugo.databinding.ActivityMainBinding binding;


    com.example.proyectogrupo1tipohugo.databinding.ActivityMainBinding ActivityMainBinding ;
                        ...
                        firebaseDatabase.getReference().child("Users").child(uid).child("as").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (rol.equals("admin")) {
                                    //guardarEstado();
                                    finish();
                                    Intent in = new Intent(MainActivity.this, com.example.proyectogrupo1tipohugo.Admin_Panel.class);
                                    startActivity(in);
                                    mDialog.dismiss();
                                    guardarEstado();
                                ...
                                if (rol.equals("usuario")) {
                                    Intent in = new Intent(MainActivity.this, com.example.proyectogrupo1tipohugo.cliente_panel.class);
                                    startActivity(in);
                                    mDialog.dismiss();
                                    guardarEstadoUser();
                                }
